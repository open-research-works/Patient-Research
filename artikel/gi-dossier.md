...
Stand September 2026 bestehen phasenweise:

- deutlicher intestinaler Druck,
- relativ wenig Gas im Verhältnis zum empfundenen Druck,
- Schleimabgang bzw. Stuhlgänge mit sehr hohem Schleimanteil,
- Brennen im Darmbereich,
- wechselnde Unruhe im Gastrointestinaltrakt,
- nächtliches Erwachen durch Beschwerden,
- zeitweise Besserung nach Stuhlgang,
- erhebliche Schwankungen innerhalb desselben Tages.
...
### Frühere intestinale Ereignisse

- **2024:** EPEC-Nachweis im Stuhl mittels Multiplex-PCR.
- **2025:** dokumentierte C.-difficile-Infektion bzw. Enteritis.
- **September 2025:** Mikrobiom-/NGS-Befund mit ausgeprägter Dysbiose, hohen Proteobakterien/E. coli und sehr niedrigen Bifidobakterien bzw. Butyratbildnern.

### Quantitative mikrobiologische Auffälligkeiten 2026

Im Mai 2026 wurden unter anderem dokumentiert:

- E. coli: `9 × 10^8 KBE/g`
- Klebsiella: `2 × 10^7 KBE/g`
- Bifidobacterium: `<1 × 10^6 KBE/g`
- Lactobacillus: `<1 × 10^3 KBE/g`

Diese Werte zeigen eine deutliche ökologische Verschiebung. Sie beweisen für sich allein jedoch nicht, dass genau diese Konstellation die aktuellen Schmerzen, den Schleim oder das Brennen verursacht.

## Kultivierte Keime: nicht einfach „der E. coli“

Aus einer späteren Kultur wurden mehrere Keime mit hohem Wachstum isoliert:

1. Escherichia coli, Isolat 1
2. Escherichia coli, hämolysierend, Isolat 2
3. Proteus mirabilis
...
## Phagen: auffällige zeitliche Reaktionen, aber keine klare Erklärung
...
- Es gab wiederholt eine zeitliche Nähe zwischen Phagengabe und GI-Veränderungen.
- Schleim und starker Druck wurden während dieser Phase dokumentiert.
- Das Phagogramm zeigte in vitro Aktivität gegen einzelne kultivierte Isolate.

### Nicht gesichert

Nicht bewiesen ist:

- dass die Phagen den Schleim verursacht haben,
- dass die Beschwerden eine sogenannte „Die-off“-Reaktion darstellen,
- dass eine klinische Verbesserung oder Verschlechterung auf die Abtötung bestimmter Keime zurückzuführen ist,
- dass eine in-vitro-Sensitivität eine klinische Wirksamkeit vorhersagt.
...
Die bisherigen Daten lassen mehrere Ebenen gleichzeitig zu.
...
Der derzeitige Stand beweist nicht:

- dass „Dysbiose“ die Ursache aller Beschwerden ist,
- dass E. coli die alleinige Ursache ist,
- dass Phagen helfen oder schaden,
- dass Schleim automatisch eine entzündliche Darmerkrankung bedeutet,
...
1. Gibt es während der Schleim-/Brennphasen objektiv messbare intestinale Entzündung?
2. Sind die kultivierten E.-coli-Isolate pathogenetisch relevant oder Ausdruck eines instabilen Ökosystems?
3. Welche Virulenzfaktoren bzw. Pathotypen tragen die beiden Isolate?
4. Verändert Phagendruck die mikrobielle Zusammensetzung tatsächlich messbar?
5. Gibt es eine Motilitätsstörung, die einen Teil von Druck und wechselnder Passage erklärt?
6. Bleibt trotz Routineendoskopie eine relevante Dünndarmachse offen?
7. Warum reagieren unterschiedliche Symptomkomponenten unterschiedlich auf Dapson bzw. Analgetika?
...
- Dünndarmdiagnostik
- Motilitätsdiagnostik und Zugangshürden
- Pathotyp-PCR der E.-coli-Isolate
- Whole-Genome-Sequencing
- Verlauf nach Phagentherapie
- wissenschaftliche Evidenz zu Schleim, Dysbiose, Enterobacteriaceae und viszeraler Sensitivität
- konkrete dokumentierte Versorgungslücken
- welche Hypothesen durch neue Befunde schwächer oder stärker werden

## Evidenzstatus

| Ebene | Aktueller Status |
|---|---|
| Eigene Symptome | dokumentierte N-of-1-Beobachtung |
| Frühere EPEC-/C.-difficile-Befunde | objektiv dokumentiert |
| Dysbiose / quantitative Flora | objektiv gemessen, klinische Kausalität offen |
| Kultivierte Keime | objektiv dokumentiert |
| Phagogramm | in-vitro-Befund |
| klinischer Phageneffekt | offen |
| Ursache von Schleim/Druck/Brennen | offen |
| Motilitätsbeteiligung | Hypothese |
| Dünndarmbeteiligung | offen |
| Literatur-/Leitlinienmodul | in Vorbereitung |
...
*Hinweis: Dieser Beitrag dokumentiert und analysiert einen anonymisierten Einzelfall. Er ersetzt keine individuelle ärztliche Diagnostik oder Behandlung und leitet aus zeitlichen Zusammenhängen keine Kausalität ab.*
